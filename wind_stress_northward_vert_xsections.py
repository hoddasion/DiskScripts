# -*- coding: utf-8 -*-
"""
Created on Mon Sep 21 10:48:50 2020
...
vmin = -3; vmax = - vmin
varname = 'atmosphere_downward_northward_stress'
cmap = 'seismic'
#%%
Test = True
if Test:
    ...
    print(maincube.data)
    #%%
    fig = workshop.plot_vertical_xsection(maincube, thetacube, orogcube,index = 6, Case = Case, cmap = cmap, vmin = vmin,vmax = vmax, levels = 20)
    plt.show()
#%%
run_loop = True
if run_loop:
    for D in resolutions:
        for leg in legs:
            ...
            for index in range(47):
                ...
                fig = workshop.plot_vertical_xsection(maincube, thetacube, orogcube,index, Case, cmap = cmap, vmin = vmin,vmax = vmax, levels = 20,alt_limit = 2000)
                workshop.save_vert_xsection(fig, maincube,index, path, Case, fileleg = leg, xaxis = 'lon')
                #plt.close()
                plt.show()
