# -*- coding: utf-8 -*-
"""
Created on Fri Jul 17 10:42:13 2020
...
if domain == 'peninsulas':
    ...
    sub_x = foundry.modf.subset_3d(xdata, South, North, West, East)
    sub_y = foundry.modf.subset_3d(ydata, South, North, West, East)
    print('sub_x', sub_x)
    sub_m = (sub_x**2 + sub_y**2)**0.5#foundry.modf.subset_2d(magdata, South, North, West, East)
    sub_msp = foundry.modf.subset_3d(mspdata, South, North, West, East) 
    ...
    for level in range(1):
        for time in range(24):
            ...
            if (time) % 1 == 0:
                ...
                print('Old Data shape =', np.shape(magdata))
                print('Data shape =', np.shape(sub_m))
