...
if flight == 306:
    ...
    fig.savefig(f'D:/Project/Figures/PNG/306/u-cc134/stat_val/RA1M_0p5km_delta_theta_timeseries_with interval_median_flt{flight}.png')
    #%%
if flight == 301:
    obs_filename = f'IGP_flights_database_obs_60s_{flight}.txt'
    path = 'D:/Project/Obvs_Data/Databases/'
    ...
    flight_suffix = ''
    df_model = pd.read_csv(f'D:/Project/Model_Data/{suite}/Matched_interpolated_values_60s_301.txt')
    um_theta = np.array(df_model['theta'])
    ...
    #ax.text(16.4, 3.0, '16:23')
    #ax.text(15.7, -2.8, r'median = $(-1.15\pm0.51)$K')
    ax.set_title(r'$\Delta\theta$ on 0p5km matched timeseries - RA1M flt301 - 60s obs')
    
    fig.savefig(f'D:/Project/Figures/PNG/{flight}/{suite}/stat_val/RA1M_0p5km_delta_theta_timeseries_flt{flight}.png')